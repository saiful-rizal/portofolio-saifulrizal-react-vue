...
.ac-timeline{display:flex;flex-direction:column;gap:0;text-align:left;position:relative;margin-left:8px;padding-left:22px;border-left:1px solid rgba(255,255,255,.22)}
.ac-item{position:relative;padding:0 0 14px}
.ac-dot{position:absolute;left:-28px;top:14px;width:11px;height:11px;border-radius:50%;background:#f5f5f5;border:3px solid #707070}
